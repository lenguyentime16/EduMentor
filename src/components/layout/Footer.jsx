...
const Footer = () => {
    const footerSections = [
        ...
        },
        {
            title: 'For Students',
            links: [
                { name: 'Tìm gia sư', href: '#' },
                { name: 'Đăng ký học', href: '#' },
                { name: 'Ứng dụng mobile', href: '#' },
                { name: 'Hỗ trợ', href: '#' }
            ]
        },
        {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
                        ...
                        <div className="lg:col-span-2">
                            <div className="flex items-center mb-4">
                                {/* [LOGO_WHITE] - White version of logo for dark background */}
                                <img
                                    src="/logo-white.png"
                                    alt="Edumentors Logo"
                            ...
                            <p className="text-gray-400 mb-6 max-w-sm">
                                Kết nối học sinh với các gia sư xuất sắc từ các trường đại học hàng đầu Việt Nam.
                            </p>
                ...
                <div className="border-t border-gray-800 py-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="text-gray-400 text-sm mb-4 md:mb-0">
                            © 2024 Edumentors. Tất cả quyền được bảo lưu.
                        </div>
